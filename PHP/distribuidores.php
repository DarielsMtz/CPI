...
$(document).ready(function() {
 ...
 <div class="lista_distribuidores" id="elemento">
     ...
     <div class="caja_dis" id="el_salvador">
         ...
         <div class="logo_dis"> <img src="./img/desktop/logo_mallo.jpg" alt="Logo Grupo Mallo S.A"> </div>
         <li>
             <h3> GRUPO MALLO S.A. DE C.V. </h3>
             <div class="icono"> <img src="./img/desktop/usuario.png">Contacto </div>
             <div class="icono"> <img src="./img/desktop/llamada-telefonica.png">Telefono </div>
             <div class="icono"> <img src="./img/desktop/email.png">Email </div>
             <div class="icono"> <img src="./img/desktop/web.png">Web </div>
         </li>
     </div>
     ...
     <div class="caja_dis" id="honduras">
         ...
         <div class="logo_dis"> <img src="./img/desktop/logo_mallo.jpg" alt="Logo Mallo Honduras"> </div>
         <li>
     ...
     <div class="caja_dis" id="guatemala">
         ...
         <div>
             <div class="logo_dis"> <img src="./img/desktop/logo_semiagro%20(1).png" alt="Logo Semiagro"> </div>
             <li>
     ...
     <div class="caja_dis" id="costa_rica">
         ...
         <div class="logo_dis"> <img src="./img/desktop/logo_mallo.jpg"> </div>
         <li>
     ...
     <div class="caja_dis" id="panama">
         ...
         <div class="logo_dis"> <img src="./img/desktop/logo_ageagro.png" alt="Logo Ageagro"> </div>
         <li>
     ...
     <div class="caja_dis" id="paraguay">
         ...
         <div class="logo_dis"> <img src="./img/desktop/logo_chimiray.png" alt="Logo Chimiray"> </div>
         <li>
             <h3> CHIMIRAY S.A. </h3>
             <div class="icono"> <img src="./img/desktop/usuario.png">Contacto </div>
             <div class="icono"> <img src="./img/desktop/llamada-telefonica.png">Telefono </div>
     ...
     <div class="caja_dis" id="argentina">
         ...
         <div class="logo_dis"> <img src="./img/desktop/logo_mayors2.png" alt="logo Mayors"> </div>
         <li>
